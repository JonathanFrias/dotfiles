...
require('lazy').setup({
  ...
  { -- Adds git related signs to the gutter, as well as utilities for managing changes
    ...
    opts = {
      ...
      current_line_blame = true, -- Set to true to enable inline blame by default
  ...
  { -- Rainbow delimiters for better nested bracket visibility
  ...
  require 'custom.plugins.rails_helpers',
  require 'custom.plugins.ruby_lsp',
